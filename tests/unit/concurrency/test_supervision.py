...
class TestRestartPolicy:
    ...
    def test_constant_backoff(self):
        ...
        assert abs(policy.calculate_delay(0) - 2.0) < 1e-6
        assert abs(policy.calculate_delay(1) - 2.0) < 1e-6
        assert abs(policy.calculate_delay(10) - 2.0) < 1e-6
    ...
    def test_linear_backoff(self):
        ...
        assert abs(policy.calculate_delay(0) - 1.0) < 1e-6
        assert abs(policy.calculate_delay(1) - 2.0) < 1e-6
        assert abs(policy.calculate_delay(2) - 3.0) < 1e-6
        assert abs(policy.calculate_delay(3) - 4.0) < 1e-6
        assert abs(policy.calculate_delay(20) - 10.0) < 1e-6  # max_delay
    ...
    def test_exponential_backoff(self):
        ...
        assert abs(policy.calculate_delay(0) - 1.0) < 1e-6   # 1 * 2^0
        assert abs(policy.calculate_delay(1) - 2.0) < 1e-6   # 1 * 2^1
        assert abs(policy.calculate_delay(2) - 4.0) < 1e-6   # 1 * 2^2
        assert abs(policy.calculate_delay(3) - 8.0) < 1e-6   # 1 * 2^3
        assert abs(policy.calculate_delay(4) - 10.0) < 1e-6  # cap at max_delay
