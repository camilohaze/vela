...
pub trait Provider<T: 'static>: Send + Sync {
    ...
    fn provide(&self, container: &super::container::DIContainer) -> DIResult<T>;
...
where
    ...
    F: Fn() -> DIResult<T> + Send + Sync,
{
    fn provide(&self, _container: &super::container::DIContainer) -> DIResult<T> {
        {
...
where
    T: 'static,
    F: Fn(&super::container::DIContainer) -> DIResult<T> + Send + Sync,
{
