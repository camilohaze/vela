...
use super::{DIError, DIResult, Scope, provider::Provider};
...
impl DIContainer {
    ...
    {
        use super::provider::SingletonProvider;
    ...
    where
        ...
        F: Fn() -> DIResult<T> + Send + Sync + 'static,
    {
        use super::provider::TransientProvider;
    ...
    {
        use super::provider::FactoryProvider;
